<?php
/**
 * Student Enlistment Report (SER)
 * Printable enlistment report
 */
...
<head>
    ...
    <title>Student Enlistment Report - <?php echo sanitize($student['student_id']); ?></title>
...
<body>
    <div class="ser-container">
        ...
        <div class="ser-header">
            <h1>STUDENT ENLISTMENT REPORT</h1>
        </div>
        ...
        <div class="ser-student-info">
            <table>
                ...
                <tr>
                    <td><strong>Enlistment Date:</strong></td>
        ...
        <div class="ser-footer" style="display: flex; justify-content: space-between; align-items: center; margin-top: 40px;">
