...
CREATE TABLE students (
    ...
    enrollment_status ENUM('Not Enlisted', 'Enlisted') DEFAULT 'Not Enlisted',
...
CREATE TABLE enrollments (
    ...
    status ENUM('Enlisted') DEFAULT 'Enlisted',
    FOREIGN KEY (student_id) REFERENCES students(student_id) ON DELETE CASCADE,
...
('2020-12345', 'Juan Dela Cruz', 'BS Computer Science', 'College of Engineering', 'juan.delacruz@plm.edu.ph', 3, 'Irregular', 'Not Enlisted'),
('2020-12346', 'Maria Santos', 'BS Information Technology', 'College of Engineering', 'maria.santos@plm.edu.ph', 2, 'Irregular', 'Not Enlisted'),
('2020-12347', 'Pedro Reyes', 'BS Computer Science', 'College of Engineering', 'pedro.reyes@plm.edu.ph', 4, 'Regular', 'Not Enlisted'),
('2020-12348', 'Ana Garcia', 'BS Information Systems', 'College of Engineering', 'ana.garcia@plm.edu.ph', 2, 'Irregular', 'Not Enlisted'),
('2020-12349', 'Carlos Mendoza', 'BS Computer Science', 'College of Engineering', 'carlos.mendoza@plm.edu.ph', 1, 'Irregular', 'Not Enlisted');
